        ...
        Parser.prototype.parseComponentValue = function () {
            ...
            if (token.type === 32 /* EOF_TOKEN */) {
                throw new SyntaxError(
                    'Error parsing CSS data value, unexpected EOF',
                );
            }
            ...
            throw new SyntaxError(
                'Error parsing CSS data value, multiple values found when expecting only one',
            );
        };
